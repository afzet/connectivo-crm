	...
	switch ($value['Lead']['status']) {
		...
		echo $html->tableCells(
			array(
				...
				$html->link($html->image('icons/vcard.png'), array('action'=>'vcard', $value['Lead']['id']), null, null, false) .' '.
				$html->link($html->image('icons/view.png'), array('action'=>'view', $value['Lead']['id']), null, null, false) .' '.
				$html->link($html->image('icons/edit.png'), array('action'=>'edit', $value['Lead']['id']), null, null, false) .' '.
				$html->link($html->image('icons/delete.png'), array('action'=>'delete', $value['Lead']['id']), null, null, false)
			),
